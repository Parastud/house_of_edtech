...
import { SearchBar } from '@/src/components/course/SearchBar';
import { SKELETON_COUNT } from '@/src/constants/app.constants';
import { useBookmarks } from '@/src/hooks/useBookmarks';
import { useCourseApi } from '@/src/hooks/useCourseApi';
import { useAppDispatch, useAppSelector } from '@/src/redux/hook';
import { setSearch } from '@/src/redux/slices/course.slice';
...
export default function CourseListScreen() {
  ...
  const handlePress = useCallback(
    (course: Course) => {
      // ✅ Fixed: route matches actual file at app/(tabs)/courses/[id].tsx
      router.push({
